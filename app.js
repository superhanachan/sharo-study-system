...
class QuizApp {
    ...
    displayMotivationalQuote() {
        const quotes = [
            { text: "始めよ。半分はすでに終わったのだ。", author: "ホラティウス / 古代ローマの詩人・哲学的文人" },
            { text: "困難だからやらないのではない。やらないから困難なのだ。", author: "ルキウス・アンナエウス・セネカ / 古代ローマのストア派哲学者" },
            { text: "ぐずぐずしている間に、人生は過ぎ去っていく。", author: "ルキウス・アンナエウス・セネカ / 古代ローマのストア派哲学者" },
            { text: "いつかできることは、すべて今日でもできる。", author: "ミシェル・ド・モンテーニュ / 16世紀フランスの哲学者・思想家" },
            { text: "知るだけでは不十分である。使わなければならない。意図するだけでは不十分である。実行しなければならない。", author: "ヨハン・ヴォルフガング・フォン・ゲーテ / ドイツの思想家・自然哲学者" },
            { text: "時を短くするものは何か。それは行動である。", author: "ヨハン・ヴォルフガング・フォン・ゲーテ / ドイツの思想家" },
            { text: "汝の進むべき道を進め、人をして言うに任せよ。", author: "ダンテ・アリギエーリ / イタリアの詩人・哲学者" },
            { text: "決心する前に完全な見通しをつけようとする者は、決心することができない。", author: "アンリ＝フレデリック・アミエル / スイスの哲学者" },
            { text: "哲学とは、知を愛し、真理に向かって実践することである。", author: "ソクラテス / 古代ギリシャの哲学者" },
            { text: "人間は行動することによってのみ、自らを定義する。", author: "ジャン＝ポール・サルトル / フランスの実存主義哲学者" },
            { text: "人生の価値は、どれだけ長く生きたかではなく、どれだけ行動したかにある。", author: "セネカ / 古代ローマのストア派哲学者" },
            { text: "計画のない意図は、単なる妄想に過ぎない。", author: "ルネ・デカルト / フランスの哲学者" },
            { text: "自らの一歩を踏み出さぬ者に、道が開かれることはない。", author: "イマヌエル・カント / ドイツの哲学者" },
            { text: "思考とは行動への準備段階に過ぎない。", author: "ウィリアム・ジェームズ / アメリカのプラグマティズム哲学者" },
            { text: "人は自由という刑に処せられている。自らの意志で行動を選び取れ。", author: "ジャン＝ポール・サルトル / フランスの実存主義哲学者" },
            { text: "明日を頼むな。今日という日を摘み取れ（カルペ・ディエム）。", author: "ホラティウス / 古代ローマの詩人" },
            { text: "知識は力なり。", author: "フランシス・ベーコン / イギリスの経験論哲学者" },
            { text: "行動を伴わない願望は、魂の腐敗を招くだけである。", author: "プラトン / 古代ギリシャの哲学者" },
            { text: "迷いの中で立ち止まるな。一歩踏み出すことが迷いを消し去る。", author: "バルーフ・デ・スピノザ / オランダの哲学者" },
            { text: "運命は、志ある者を導き、志なき者を引きずっていく。", author: "クレアンテス / 古代ギリシャのストア派哲学者" },
            { text: "無知の知（己が無知であることを知る者が、最も賢い）。", author: "ソクラテス / 古代ギリシャの哲学者" },
            { text: "吟味されない人生は、生きるに値しない。", author: "ソクラテス / 古代ギリシャの哲学者" },
            { text: "我思う、ゆえに我あり。", author: "ルネ・デカルト / フランスの哲学者・数学者" },
            { text: "敢えて賢明であれ（サペレ・アウデ：自らの理性を用いる勇気を持て）。", author: "イマヌエル・カント / ドイツの哲学者" },
            { text: "学問の根は苦いが、その果実は甘い。", author: "アリストテレス / 古代ギリシャの哲学者" },
            { text: "読書とは、過去の最も優れた頭脳と対話することである。", author: "ルネ・デカルト / フランスの哲学者" },
            { text: "人間は考える葦である。", author: "ブレーズ・パスカル / フランスの哲学者・数学者" },
            { text: "知恵の始まりは、言葉の定義にある。", author: "ソクラテス / 古代ギリシャの哲学者" },
            { text: "知識とは、思い出されるものである。", author: "プラトン / 古代ギリシャの哲学者" },
            { text: "真理は、単純さの中にこそ見出される。", author: "アイザック・ニュートン / イギリスの自然哲学者・物理学者" },
            { text: "疑問を抱くことこそが、知恵の源泉である。", author: "ルネ・デカルト / フランスの哲学者" },
            { text: "精神の修養なき知識は、ただの重荷に過ぎない。", author: "セネカ / 古代ローマのストア派哲学者" },
            { text: "人間は生まれながらにして、知ることを欲する。", author: "アリストテレス / 古代ギリシャの哲学者" },
            { text: "学びて思わざれば盲目となり、思いて学ばざれば空虚となる。", author: "イマヌエル・カント / ドイツの哲学者" },
            { text: "真の教育とは、魂の目を正しい方向へ向けさせることである。", author: "プラトン / 古代ギリシャの哲学者" },
            { text: "人は知性によって自らの世界を広げる。", author: "ジョン・ロック / イギリスの経験論哲学者" },
            { text: "我々は知れば知るほど、自らの知らぬことの多さに驚かされる。", author: "ニコラウス・クザーヌス / 中世ドイツの哲学者" },
            { text: "理解できないものを信じるな、だが理解しようと努めよ。", author: "ピエール・ベール / フランスの哲学者" },
            { text: "偏見とは、理性が目覚める前に心に植え付けられた判断である。", author: "ヴォルテール / フランスの啓蒙思想家" },
            { text: "精神は自ら鍛錬することでしか、その真価を発揮しない。", author: "ゴットフリート・ライプニッツ / ドイツの哲学者" },
            { text: "我々の性格は、反復する行為によって作られる。卓越とは行為ではなく、習慣である。", author: "アリストテレス / 古代ギリシャの哲学者" },
            { text: "習慣は第二の天性である。", author: "キケロ / 古代ローマの哲学者・政治家" },
            { text: "川の水が岩を削るのは、力によるのではなく、その継続による。", author: "オウィディウス / 古代ローマの詩人・ストア派的文人" },
            { text: "習慣が変われば人格が変わり、人格が変われば運命が変わる。", author: "ウィリアム・ジェームズ / アメリカのプラグマティズム哲学者" },
            { text: "偉大な事業は、小さなことの積み重ねによってのみ成し遂げられる。", author: "バルーフ・デ・スピノザ / オランダの哲学者" },
            { text: "忍耐は希望を持つための技術である。", author: "リュック・ド・クラピエ・ド・ヴォーヴナルグ / フランスのモラリスト哲学者" },
            { text: "精神の鍛錬を1日怠れば自らが気づき、2日怠れば他人が気づく。", author: "ルネ・デカルト / フランスの哲学者" },
            { text: "小さな努力の連続こそが、巨大な壁を打ち破る唯一の武器である。", author: "トマス・アクィナス / 中世スコラ哲学者" },
            { text: "習慣に支配されるな、良き習慣を支配せよ。", author: "ジョン・スチュアート・ミル / イギリスの功利主義哲学者" },
            { text: "自らを制御する反復こそが、自由への道である。", author: "エピクテトス / 古代ギリシャ・ローマのストア派哲学者" },
            { text: "規律なき自由は、自滅を招く。", author: "イマヌエル・カント / ドイツの哲学者" },
            { text: "毎日を最後の一日であるかのように過ごせ。", author: "マルクス・アウレリウス / 古代ローマ皇帝・ストア派哲学者" },
            { text: "困難なことの多くは、反復によって容易になる。", author: "トマス・ホッブズ / イギリスの政治哲学者" },
            { text: "人は自らが日々行うことそのものになる。", author: "デイヴィッド・ヒューム / スコットランドの経験論哲学者" },
            { text: "意志の力とは、毎日の小さな決断の積み重ねによってのみ養われる。", author: "ショーペンハウアー / ドイツの哲学者" },
            { text: "途中で投げ出さぬこと、それ自体が知恵の証である。", author: "セネカ / 古代ローマのストア派哲学者" },
            { text: "怠惰は魂の錆であり、反復は魂の研磨である。", author: "モンテスキュー / フランスの法哲学者" },
            { text: "規則正しさは、天才を生み出す土壌である。", author: "ゲオルク・ヴィルヘルム・フリードリヒ・ヘーゲル / ドイツ観念論哲学者" },
            { text: "時間を最も有効に使う者は、習慣を味方につけた者である。", author: "ゴットフリート・ライプニッツ / ドイツの哲学者" },
            { text: "忍耐なくして、いかなる真理にも到達することはできない。", author: "ヨハン・ゴットリープ・フィヒテ / ドイツ観念論哲学者" },
            { text: "苦悩を突き抜けて歓喜に至れ。", author: "フリードリヒ・ニーチェ / ドイツの哲学者" },
            { text: "我々を殺さないものは、我々をいっそう強くする。", author: "フリードリヒ・ニーチェ / ドイツの哲学者" },
            { text: "人を不安にするのは事象そのものではなく、事象に対する自らの見解である。", author: "エピクテトス / 古代ギリシャ・ローマのストア派哲学者" },
            { text: "汝の運命を愛せよ（アモール・ファーティ）。", author: "フリードリヒ・ニーチェ / ドイツの哲学者" },
            { text: "自分の力で変えられないものを思い悩むな。変えられるものに全力を尽くせ。", author: "エピクテトス / 古代ギリシャ・ローマのストア派哲学者" },
            { text: "他人の目を通して自分を見るな。己の魂の目で見よ。", author: "マルクス・アウレリウス / 古代ローマ皇帝・ストア派哲学者" },
            { text: "朝起きたら自分に言え。「今日、私は無礼な者、恩知らずな者に出会うだろう。だが私はそれに動じない」。", author: "マルクス・アウレリウス / 古代ローマ皇帝・ストア派哲学者" },
            { text: "最悪の敵は、自分自身の心の中に潜んでいる。", author: "キケロ / 古代ローマの哲学者" },
            { text: "苦難は人間を試す試金石である。", author: "アルトゥル・ショーペンハウアー / ドイツの哲学者" },
            { text: "絶望の淵に立たされたときこそ、人間の真の強さが試される。", author: "セーレン・キェルケゴール / デンマークの実存主義哲学者" },
            { text: "自らを支配できない者に、真の自由はない。", author: "ピタゴラス / 古代ギリシャの哲学者・数学者" },
            { text: "魂の静寂（アタラクシア）を乱すものは、すべて外部ではなく己の内にある。", author: "エピクロス / 古代ギリシャの快楽主義哲学者" },
            { text: "嵐が船を揺らすことはあっても、船の進路を決めるのは舵手である。", author: "セネカ / 古代ローマのストア派哲学者" },
            { text: "怒りは一時の狂気である。それを制御せよ。", author: "ホラティウス / 古代ローマの詩人・哲学的文人" },
            { text: "己の弱さを認めることこそが、強さの第一歩である。", author: "ジャン＝ジャック・ルソー / フランスの思想家・哲学者" },
            { text: "苦痛を避けるのではなく、苦痛に耐えうる魂を育てよ。", author: "フリードリヒ・ニーチェ / ドイツの哲学者" },
            { text: "恐れは常に無知から生じる。", author: "ラルフ・ワルド・エマーソン / アメリカの超越主義哲学者" },
            { text: "障害そのものが道となる。進路を阻むものが、前進を促す。", author: "マルクス・アウレリウス / 古代ローマ皇帝・ストア派哲学者" },
            { text: "不幸を恐れるあまりに、幸福への挑戦を止めてはならない。", author: "ルキウス・アンナエウス・セネカ / 古代ローマのストア派哲学者" },
            { text: "外部の出来事に心を奪われるな。内なる城塞を強固に保て。", author: "マルクス・アウレリウス / 古代ローマ皇帝・ストア派哲学者" },
            { text: "意志あるところに道は開ける。", author: "ジョン・スチュアート・ミル / イギリスの哲学者" },
            { text: "幸運とは、準備と機会が出会うことである。", author: "ルキウス・アンナエウス・セネカ / 古代ローマのストア派哲学者" },
            { text: "人生とは、自分を見つけることではない。自分を創り上げることだ。", author: "ジョージ・バーナード・ショー / アイルランドの劇作家・思想家" },
            { text: "自分の可能性を信じない者に、勝利の女神は微笑まない。", author: "フリードリヒ・フォン・シラー / ドイツの詩人・劇作家・哲学者" },
            { text: "汝自身を知れ。", author: "デルポイのアポロン神殿の神託・ソクラテスの座右の銘" },
            { text: "超人とは、自らの限界を絶えず乗り越え続ける者のことである。", author: "フリードリヒ・ニーチェ / ドイツの哲学者" },
            { text: "勝利は、最も粘り強く耐え抜いた者の手に落ちる。", author: "トマス・ホッブズ / イギリスの政治哲学者" },
            { text: "他人と比べるな。昨日の己と比較せよ。", author: "フリードリヒ・ニーチェ / ドイツの哲学者" },
            { text: "自分の運命の主人は、自分自身である。", author: "ヘンリー・デイヴィッド・ソロー / アメリカの自然哲学者・思想家" },
            { text: "人はその考え通りの人間になる。", author: "マルクス・アウレリウス / 古代ローマ皇帝・ストア派哲学者" },
            { text: "恐れるな。ただ真理と正義を信じて前へ進め。", author: "イマヌエル・カント / ドイツの哲学者" },
            { text: "自信とは、自らの理性を徹底的に信じ抜くことから生まれる。", author: "バルーフ・デ・スピノザ / オランダの哲学者" },
            { text: "最高善とは、魂が徳に従って活動することである。", author: "アリストテレス / 古代ギリシャの哲学者" },
            { text: "人生における最大の栄光は、一度も倒れないことではなく、倒れるたびに立ち上がることにある。", author: "オリヴァー・ゴールドスミス / 18世紀アイルランドの文人・思想家" },
            { text: "準備を万全にした者にとって、試練は実力を証明するための舞台に過ぎない。", author: "セネカ / 古代ローマのストア派哲学者" },
            { text: "我々は自らの意志によって、運命を超えることができる。", author: "フリードリヒ・ヘーゲル / ドイツ観念論哲学者" },
            { text: "志高き者は、泥沼の中でも夜空の星を見上げる。", author: "オスカー・ワイルド / アイルランドの作家・審美主義思想家" },
            { text: "精神の自由を勝ち取った者だけが、真の勝者となる。", author: "バールーフ・デ・スピノザ / オランダの哲学者" },
            { text: "名誉は、最も困難な義務を果たした者に与えられる。", author: "プラトン / 古代ギリシャの哲学者" },
            { text: "自らの力で勝ち取った果実だけが、真に甘美である。", author: "ミシェル・ド・モンテーニュ / フランスのモラリスト哲学者" }
        ];
