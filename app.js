...
class QuizApp {
    ...
    applyAutoFill() {
        // Even if AUTO:OFF, save current state so localStorage stays in sync with in-memory Set
        ...
        if (!set || set.type === 'folder') { this.saveAutoFilledAnswers(); return; }
        ...
        // Always persist after applyAutoFill runs (even if AUTO:OFF, saves whatever is currently tracked)
        this.saveAutoFilledAnswers();
    }
    ...
    resetQuiz() {
        ...
        // Note: Do NOT save autoFilledAnswers here - wait for applyAutoFill() to repopulate and save.
    ...
    updateDashboard() {
        ...
        buildInfo.textContent = `BUILD: 2026-03-12 17:10 (AUTOFILL PERSIST FIX2) [AUTO:${autoFillStatus}]`;
        if (this.homeDashboard && !document.getElementById('build-info')) {
            ...
            document.getElementById('build-info').textContent = `BUILD: 2026-03-12 17:10 (AUTOFILL PERSIST FIX2) [AUTO:${autoFillStatus}]`;
        }
