...
class QuizApp {
    ...
    displayMotivationalQuote() {
        const quotes = [
            { text: "志を立てて、以て万事の源と為す。", author: "『史記』" },
            { text: "千里の行も足下に始まる。", author: "『老子』" },
            { text: "燕雀安ぞ鴻鵠の志を知らんや（えんじゃくいずくんぞこうこくのこころざしをしらんや）。", author: "『史記』陳渉世家" },
            { text: "始めよ。半分はすでに終わったのだ。", author: "『戦国策』" },
            { text: "志ある者は事竟に成る（こころざしあるものはことついに成る）。", author: "『後漢書』耿弇伝" },
            { text: "乾坤一擲（けんこんいってき）。", author: "『唐宋八大家文読本』韓愈" },
            { text: "人事を尽くして天命を待つ。", author: "『読史管見』胡寅" },
            { text: "精神一到何事か成らざらん。", author: "『朱子語類』朱熹" },
            { text: "破釜沈舟（釜を破り舟を沈む：退路を断ち決死で挑む）。", author: "『史記』項羽本紀" },
            { text: "百里を行く者は九十を半ばとす。", author: "『戦国策』秦策" },
            { text: "疑心暗鬼を生ず。", author: "『列子』説符篇" },
            { text: "一念岩をも通す。", author: "『史記』李将軍列伝" },
            { text: "少年老い易く学成り難し、一寸の光陰軽んずべからず。", author: "『偶成』朱熹" },
            { text: "先んずれば即ち人を制し、後るれば即ち人の制する所と為る。", author: "『史記』項羽本紀" },
            { text: "禍を転じて福と為す。", author: "『戦国策』楚策" },
            { text: "学問は逆水を行く舟の如し、進まざれば則ち退く。", author: "『十八史略』" },
            { text: "虎穴に入らずんば虎子を得ず。", author: "『後漢書』班超伝" },
            { text: "一日の計は晨（あした）にあり、一年の計は春にあり。", author: "『通俗編』" },
            { text: "当に断ずべくして断ぜざれば、反りて其の乱を受く。", author: "『史記』春申君列伝" },
            { text: "大器は晩成す。", author: "『老子』" },
            { text: "学んで思わざれば則ち罔（くら）く、思うて学ばざれば則ち殆（あやう）し。", author: "『論語』為政篇" },
            { text: "学問に近道なし、積みて以て成す。", author: "『荀子』勧学篇" },
            { text: "読書百遍、意自ずから通ず。", author: "『三国志』魏書・董遇伝" },
            { text: "温故にして知新。", author: "『論語』為政篇" },
            { text: "騏驥（きき）の一躍も十歩に及ぶ能わず、駑馬（どば）の十駕も功は舎（す）てざるに在り。", author: "『荀子』勧学篇" },
            { text: "玉磨かざれば光なし、人学ばざれば道を知らず。", author: "『礼記』学記篇" },
            { text: "日々新にして、また日々に新なれ。", author: "『大学』" },
            { text: "涓滴岩を穿つ（けんてきいわをうがつ）。", author: "『漢書』枚乗伝" },
            { text: "雨垂れ石を穿つ。", author: "『漢書』" },
            { text: "三人行けば必ず我が師あり。", author: "『論語』述而篇" },
            { text: "愚公、山を移す。", author: "『列子』湯問篇" },
            { text: "渇すれども盗泉の水を飲まず。", author: "『文選』陸機" },
            { text: "水積もりて川を成し、土積もりて山を成す。", author: "『荀子』儒効篇" },
            { text: "業は精に荒（すさ）み、行は思に毀（こぼ）つ。", author: "『進学解』韓愈" },
            { text: "青はこれを藍より取りて藍よりも青し。", author: "『荀子』勧学篇" },
            { text: "学びて時にこれを習う、亦た説（よろこ）ばしからずや。", author: "『論語』学而篇" },
            { text: "木を伐るに斧を研がざれば労多くして功少なし。", author: "『淮南子』" },
            { text: "切磋琢磨。", author: "『詩経』衛風・淇奥" },
            { text: "敏にして学を好み、下問を恥じず。", author: "『論語』公冶長篇" },
            { text: "日に三たび吾が身を省みる。", author: "『論語』学而篇" },
            { text: "疾風に勁草（けいそう）を知る。", author: "『後漢書』王覇伝" },
            { text: "臥薪嘗胆（がしんしょうたん）。", author: "『十八史略』・『史記』越王句践世家" },
            { text: "塞翁が馬、焉ぞ福と知らん。", author: "『淮南子』人間訓" },
            { text: "人皆直きを知りて、枉（ま）がるるを知らず。", author: "『史記』屈原賈生列伝" },
            { text: "窮すれば則ち変じ、変ずれば則ち通ず。", author: "『易経』繋辞下伝" },
            { text: "死中に活を求む。", author: "『後漢書』公孫述伝" },
            { text: "磨励自強（まれいじきょう：苦難の中で己を磨き強くする）。", author: "『三国志』" },
            { text: "霜を履（ふ）んで堅氷至る。", author: "『易経』坤卦" },
            { text: "天のまさに大任をこの人に降さんとするや、必ず先ずその心志を苦しむ。", author: "『孟子』告子下篇" },
            { text: "背水の陣。", author: "『史記』淮陰侯列伝" },
            { text: "百折不撓（ひゃくせつふとう：幾度挫折しても屈しない）。", author: "『蔡中郎集』蔡邕" },
            { text: "困知勉行（苦しみながら学び、努力して実行する）。", author: "『中庸』" },
            { text: "禍福は糾（あざな）える縄の如し。", author: "『史記』南越列伝" },
            { text: "寒禽（かんきん）木を択ばず。", author: "『三国志』蜀書" },
            { text: "捲土重来（けんどちょうらい：一度敗れた者が勢いを盛り返して攻め寄せる）。", author: "『題烏江亭』杜牧" },
            { text: "暗雲去りて陽光現る。", author: "『晋書』" },
            { text: "霜雪を経て松柏の操（みさお）を知る。", author: "『後漢書』" },
            { text: "忍の一字は衆妙の門。", author: "『資治通鑑』" },
            { text: "氷は水より出でて水よりも寒し。", author: "『荀子』勧学篇" },
            { text: "長風破浪（ちょうふうはろう：荒波を突き破り前進する）。", author: "『宋書』宗愨伝" },
            { text: "彼を知り己を知れば、百戦殆（あやう）からず。", author: "『孫子』謀攻篇" },
            { text: "勝兵は先ず勝ちて而る後に戦いを求め、敗兵は先ず戦いて而る後に勝を求む。", author: "『孫子』形篇" },
            { text: "勝敗は兵家の常。", author: "『新唐書』裴度伝" },
            { text: "兵は拙速を聞く、未だ巧の久しきを賭（み）ざるなり。", author: "『孫子』作戦篇" },
            { text: "機を見るに敏ならんと欲す。", author: "『易経』系辞下伝" },
            { text: "其の疾（はや）きこと風の如く、其の徐（しず）かなること林の如し。", author: "『孫子』軍争篇" },
            { text: "侵掠すること火の如く、動かざること山の如し。", author: "『孫子』軍争篇" },
            { text: "勝を制するは差（わず）かの間にあり。", author: "『三国志』呉書" },
            { text: "智者は千慮に一失あり、愚者は千慮に一得あり。", author: "『史記』淮陰侯列伝" },
            { text: "敵の備え無きを攻め、其の不意に出づ。", author: "『孫子』計篇" },
            { text: "尺蠖（しゃっかく）の屈するは、以て信（の）びんことを求むるなり。", author: "『易経』繋辞下伝" },
            { text: "善く戦う者は人を致して人に致されず。", author: "『孫子』虚実篇" },
            { text: "細心にして大胆なれ。", author: "『晋書』" },
            { text: "勝つべからざるは己に在り、勝つべきは敵に在り。", author: "『孫子』形篇" },
            { text: "机上の空論を排し、実戦に備えよ。", author: "『史記』廉頗藺相如列伝・趙括の故事" },
            { text: "算多きは勝ち、算少なきは勝たず。", author: "『孫子』計篇" },
            { text: "力は山を抜き、気は世を蓋（おお）う。", author: "『史記』項羽本紀" },
            { text: "小敵の堅は、大敵の擒（とりこ）なり。", author: "『孫子』謀攻篇" },
            { text: "勇者の奮起は一軍を動かす。", author: "『三国志』魏書" },
            { text: "兵貴神速（兵は神速を貴ぶ）。", author: "『三国志』魏書・郭嘉伝" },
            { text: "堤の蟻穴（ぎけつ）をもって壊れ、障の隙風をもって焚かる。", author: "『韓非子』喩老篇" },
            { text: "始め有らざるは無し、克（よ）く終り有るは鮮（すく）なし。", author: "『詩経』大雅・蕩" },
            { text: "九仞（きゅうじん）の功を一簣（いっき）に虧（か）く。", author: "『書経』旅獒篇" },
            { text: "今日復（ま）た今日、今日何ぞ其れ少なき。", author: "『今日歌』文嘉" },
            { text: "自ら彊（つと）めて息（や）まず。", author: "『易経』乾卦" },
            { text: "日々是好日。", author: "『碧巌録』" },
            { text: "居安思危（安きに居て危うきを思う）。", author: "『春秋左氏伝』襄公十一年" },
            { text: "怠慢は百禍の源なり。", author: "『資治通鑑』" },
            { text: "慎終如始（終りを慎むこと始めの如くす）。", author: "『老子』第六十四章" },
            { text: "積善の家に必ず余慶あり。", author: "『易経』坤卦" },
            { text: "千丈の堤も螻蟻（ろうぎ）の穴を以て潰ゆ。", author: "『韓非子』喩老篇" },
            { text: "驕れる者は久しからず。", author: "『尚書』" },
            { text: "己に克ちて礼に復（かえ）る。", author: "『論語』顔淵篇" },
            { text: "歳寒くして、然る後に松柏の彫（しぼ）むに後（おく）るるを知る。", author: "『論語』子罕篇" },
            { text: "禍は微（かす）かなるに起こり、憂いは細大に生ず。", author: "『史記』" },
            { text: "足るを知る者は富み、強めて行う者は志有り。", author: "『老子』第三十三章" },
            { text: "駑馬十駕、功在不舎（才能の劣る馬も歩みを止めねば千里に至る）。", author: "『荀子』勧学篇" },
            { text: "過ちて改めざる、これを過ちと謂う。", author: "『論語』衛霊公篇" },
            { text: "志を同じくする者は日夜を分かたず。", author: "『三国志』蜀書" },
            { text: "金石猶（な）お開くべし、何を以てか成らざらん。", author: "『後漢書』" }
        ];
