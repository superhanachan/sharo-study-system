...
class QuizApp {
    ...
    displayMotivationalQuote() {
        const quotes = [
            { text: "いつかできることは、すべて今日でもできる。", author: "ミシェル・ド・モンテーニュ / 16世紀フランスの思想家『エセー』" },
            { text: "最も困難なのは、始めるという決断を下すことだ。残りは単なる粘り強さに過ぎない。", author: "アメリア・イアハート / 20世紀アメリカの女性飛行士" },
            { text: "千里の行も足下に始まる。", author: "老子 / 古代中国の思想家『老子道徳経』" },
            { text: "始めよ。半分はすでに終わったのだ。", author: "ホラティウス / 古代ローマの詩人『書簡詩』" },
            { text: "チャンスは、準備された心にのみ微笑む。", author: "ルイ・パスツール / 19世紀フランスの細菌学者" },
            { text: "決心する前に完全な見通しをつけようとする者は、決心することができない。", author: "アンリ＝フレデリック・アミエル / 19世紀スイスの哲学者『アミエルの日記』" },
            { text: "明日死ぬかのように生きよ。永遠に生きるかのように学べ。", author: "マハトマ・ガンディー / 20世紀インドの独立運動指導者" },
            { text: "ぐずぐずしている間に、人生は過ぎ去っていく。", author: "セネカ / 古代ローマの哲学者『生の短さについて』" },
            { text: "計画のない目標は、ただの願い事にすぎない。", author: "アントワーヌ・ド・サン＝テグジュペリ / 20世紀フランスの作家『夜間飛行』" },
            { text: "志を立てて、以て万事の源と為す。", author: "吉田松陰 / 幕末日本の思想家・教育者" },
            { text: "鉄は熱いうちに打て。", author: "プブリウス・シルス / 紀元前1世紀古代ローマの劇作家" },
            { text: "困難だからやらないのではない。やらないから困難なのだ。", author: "セネカ / 古代ローマの哲学者『書簡集』" },
            { text: "迷ったら、自分を最も高める道を選べ。", author: "ジョン・スチュアート・ミル / 19世紀イギリスの哲学者『自由論』" },
            { text: "小事を軽んじる者は、大事を成し遂げることができない。", author: "孔子 / 古代中国の思想家『論語』" },
            { text: "人の世に道は一つということはない。道は百も千も万もある。", author: "坂本龍馬 / 幕末日本の志士" },
            { text: "時を短くするものは何か。それは行動である。", author: "ヨハン・ヴォルフガング・フォン・ゲーテ / 18〜19世紀ドイツの文豪" },
            { text: "思い立ったが吉日。", author: "日本の故事・ことわざ" },
            { text: "始めるための最良の方法は、話すのをやめて行動することだ。", author: "ウォルト・ディズニー / 20世紀アメリカのアニメーション映画製作者" },
            { text: "汝の進むべき道を進め、人をして言うに任せよ。", author: "ダンテ・アリギエーリ / 13〜14世紀イタリアの詩人『神曲』" },
            { text: "知識を行動に移さなければ、知識を持たないのと同じである。", author: "王陽明 / 明代中国の思想家・陽明学の祖『伝習録』" },
            { text: "習慣は第二の天性である。", author: "キケロ / 紀元前1世紀古代ローマの政治家・哲学者" },
            { text: "天才とは、1％のひらめきと99％の努力である。", author: "トーマス・エジソン / 19〜20世紀アメリカの発明家" },
            { text: "雨垂れ石を穿つ。", author: "班固 / 後漢の歴史家『漢書』" },
            { text: "天才とは、努力を続けられる人のことである。", author: "エルバート・ハバード / 19〜20世紀アメリカの作家" },
            { text: "習慣が変われば人格が変わり、人格が変われば運命が変わる。", author: "ウィリアム・ジェームズ / 19〜20世紀アメリカの心理学者・哲学者" },
            { text: "愚公、山を移す。", author: "列子 / 古代中国の思想書『列子』湯問篇" },
            { text: "一滴の水が集まって大河となる。", author: "ブッダ / 古代インドの仏教開祖『法句経』" },
            { text: "日々新にして、また日々に新なれ。", author: "『大学』/ 古代中国の儒教経典" },
            { text: "読書百遍、意自ずから通ず。", author: "陳寿 / 三国時代の歴史家『三国志』魏書・董遇伝" },
            { text: "偉大な事業は、小さなことの積み重ねによって成し遂げられる。", author: "フィンセント・ファン・ゴッホ / 19世紀オランダの画家" },
            { text: "勤勉は幸運の母である。", author: "ミゲル・デ・セルバンテス / 16〜17世紀スペインの作家『ドン・キホーテ』" },
            { text: "学問に王道なし。", author: "プロクレオスが伝えたユークリッドの言葉 / 古代ギリシャの数学者" },
            { text: "毎日のわずかな差が、歳月を経て埋めがたい巨大な隔たりとなる。", author: "福沢諭吉 / 明治日本の思想家『学問のすすめ』" },
            { text: "忍耐は希望を持つための技術である。", author: "リュック・ド・クラピエ・ド・ヴォーヴナルグ / 18世紀フランスのモラリスト" },
            { text: "川の水が岩を削るのは、その力によるのではなく、その持続による。", author: "オウィディウス / 古代ローマの詩人" },
            { text: "涓滴岩を穿つ（けんてきいわをうがつ）。", author: "中国古典の格言" },
            { text: "我々の性格は、我々の行動の反復によって作られる。", author: "アリストテレス / 古代ギリシャの哲学者『ニコマコス倫理学』" },
            { text: "百日の労を積みて、一朝の効を収む。", author: "韓非子 / 古代中国の思想家『韓非子』" },
            { text: "繰り返し行うことが、我々を形作る。ゆえに卓越とは行為ではなく習慣である。", author: "ウィル・デュラント / 20世紀アメリカの哲学者『哲学の歴史』" },
            { text: "終始一貫、志を変えざる者を真の士とす。", author: "西郷隆盛 / 幕末・明治日本の政治家・武士" },
            { text: "夜明け前が、一番暗い。", author: "トマス・フラー / 17世紀イギリスの神学者" },
            { text: "失敗したところでやめるから失敗になる。成功するまで続ければ、それは成功への過程になる。", author: "松下幸之助 / 20世紀日本の実業家・パナソニック創業者" },
            { text: "困難の中にこそ、チャンスがある。", author: "アルベルト・アインシュタイン / 20世紀物理学者" },
            { text: "苦難は人間を試す試金石である。", author: "ウィリアム・シェイクスピア / 16〜17世紀イギリスの劇作家『お気に召すまま』" },
            { text: "我々を殺さないものは、我々をいっそう強くする。", author: "フリードリヒ・ニーチェ / 19世紀ドイツの哲学者『偶像の黄昏』" },
            { text: "七転び八起き。", author: "日本の禅の精神に基づく故事ことわざ" },
            { text: "艱難汝を玉にす。", author: "西洋の格言「Adversity makes a man wise, not rich」に基づく邦訳" },
            { text: "逆境は人を賢くする。", author: "バイロン / 18〜19世紀イギリスの詩人" },
            { text: "冬来たりなば春遠からじ。", author: "パーシー・ビッシュ・シェリー / 18〜19世紀イギリスの詩人『西風の詩』" },
            { text: "人間万事塞翁が馬。", author: "劉安編『淮南子』/ 古代中国・前漢時代の思想書" },
            { text: "プレッシャーとは、特権である。", author: "ビリー・ジーン・キング / 20世紀アメリカのテニス選手" },
            { text: "神は乗り越えられない試練を与えない。", author: "『新約聖書』コリントの信徒への手紙一・10章13節" },
            { text: "嵐の後には必ず青空が広がる。", author: "ダニエル・デフォー / 17〜18世紀イギリスの作家『ロビンソン・クルーソー』" },
            { text: "スランプに陥ったときこそ、基礎に帰れ。", author: "ヴィンス・ロンバルディ / 20世紀アメリカのアメリカンフットボール名監督" },
            { text: "失敗とは、より賢明に再挑戦するための好機にすぎない。", author: "ヘンリー・フォード / 19〜20世紀アメリカの実業家・フォード創業者" },
            { text: "最も暗い夜でも、必ず朝は来る。", author: "ヴィクトル・ユーゴー / 19世紀フランスの作家『レ・ミゼラブル』" },
            { text: "疾風に勁草（けいそう）を知る。", author: "范曄 / 後漢の歴史書『後漢書』王覇伝" },
            { text: "苦悩を突き抜けて歓喜に至れ。", author: "ルートヴィヒ・ヴァン・ベートーヴェン / 18〜19世紀ドイツの作曲家" },
            { text: "悲観主義者は風にうらみを言う。楽観主義者は風がやむのを待つ。現実主義者は帆を合わせる。", author: "ウィリアム・アーサー・ウォード / 20世紀アメリカの教育者" },
            { text: "汝の運命を愛せよ。", author: "フリードリヒ・ニーチェ / 19世紀ドイツの哲学者『この人を見よ』" },
            { text: "不可能とは、事実ではなく単なる意見に過ぎない。", author: "モハメド・アリ / 20世紀アメリカのプロボクサー" },
            { text: "覚悟を決めた人間の前からは、道が自然と開けていく。", author: "ラルフ・ワルド・エマーソン / 19世紀アメリカの思想家『自己信頼』" },
            { text: "幸運とは、準備と機会が出会うことである。", author: "セネカ / 古代ローマの哲学者" },
            { text: "他人の目を通して自分を見るな。己の魂の目で見よ。", author: "マルクス・アウレリウス / 古代ローマ皇帝・哲学者『自省録』" },
            { text: "我思う、ゆえに我あり。", author: "ルネ・デカルト / 17世紀フランスの哲学者『方法序説』" },
            { text: "意志あるところに道は開ける。", author: "エイブラハム・リンカーン / 19世紀アメリカ大統領" },
            { text: "己を知り敵を知れば、百戦危うからず。", author: "孫武 / 古代中国の軍事思想家『孫子』謀攻篇" },
            { text: "人生は自ら創り出すものである。", author: "ジョージ・バーナード・ショー / 19〜20世紀アイルランドの劇作家" },
            { text: "自分の可能性を信じない者に、勝利の女神は微笑まない。", author: "フリードリヒ・フォン・シラー / 18世紀ドイツの詩人・劇作家" },
            { text: "一事を成し得ぬ者は、万事を成し得ず。", author: "新渡戸稲造 / 明治・大正日本の教育者・思想家" },
            { text: "人生とは、自分を見つけることではない。自分を創り上げることだ。", author: "ジョージ・バーナード・ショー / 19〜20世紀アイルランドの劇作家" },
            { text: "精神一到何事か成らざらん。", author: "朱熹 / 南宋の儒学者『朱子語類』" },
            { text: "人はその考え通りの人間になる。", author: "ジェームズ・アレン / 19〜20世紀イギリスの哲学者『原因と結果の法則』" },
            { text: "最悪の敵は、自分自身の心の中にある。", author: "キケロ / 紀元前1世紀古代ローマの政治家・哲学者" },
            { text: "志高き者は、泥沼の中でも星を見上げる。", author: "オスカー・ワイルド / 19世紀アイルランドの作家『ウィンダミア卿夫人の扇』" },
            { text: "自ら助くる者を、天は助く。", author: "サミュエル・スマイルズ / 19世紀イギリスの作家『自助論』" },
            { text: "身はたとひ武蔵の野辺に朽ちぬとも留め置かまし大和魂。", author: "吉田松陰 / 幕末日本の思想家・辞世の句" },
            { text: "恐れは常に無知から生じる。", author: "ラルフ・ワルド・エマーソン / 19世紀アメリカの思想家" },
            { text: "自分の運命の主人たる者は、自分自身である。", author: "ヘンリー・デイヴィッド・ソロー / 19世紀アメリカの思想家『ウォールデン 森の生活』" },
            { text: "己に克つ者を強者と呼ぶ。", author: "老子 / 古代中国の思想家『老子道徳経』第33章" },
            { text: "勝利は、最も粘り強い者の手に落ちる。", author: "ナポレオン・ボナパルト / 18〜19世紀フランスの皇帝" },
            { text: "勝敗は兵家の常なれど、最後まで諦めざる者が勝つ。", author: "司馬遷 / 前漢の歴史家『史記』項羽本紀" },
            { text: "勝ちたいという意志は重要だが、勝つための準備をする意志はそれ以上に重要である。", author: "ボブ・ナイト / 20世紀アメリカのバスケットボール指導者" },
            { text: "勝者は決して諦めず、諦める者は決して勝てない。", author: "ヴィンス・ロンバルディ / 20世紀アメリカのアメリカンフットボール名監督" },
            { text: "賽は投げられた。", author: "ガイウス・ユリウス・カエサル / 紀元前1世紀古代ローマの政治家・軍人" },
            { text: "最後の瞬間まで勝負を投げるな。運命の女神は執念深き者を愛す。", author: "プラウトゥス / 古代ローマの喜劇作家" },
            { text: "準備を万全にした者にとって、本番は実力を示す舞台にすぎない。", author: "スネカ / 古代ローマの哲学者" },
            { text: "乾坤一擲（けんこんいってき）。", author: "韓愈 / 唐代中国の文学者『過鴻溝』" },
            { text: "栄光は、一瞬の閃きではなく、長きにわたる忍耐の末に訪れる。", author: "レオナルド・ダ・ヴィンチ / 15〜16世紀イタリアの万能人" },
            { text: "人事を尽くして天命を待つ。", author: "胡寅 / 南宋の儒学者『読史管見』" },
            { text: "一寸の光陰軽んずべからず。", author: "朱熹 / 南宋の儒学者『偶成』" },
            { text: "たとえ明日世界が滅亡しようとも、今日私はリンゴの木を植える。", author: "マルティン・ルター / 16世紀ドイツの宗教改革者" },
            { text: "偉大な成果は、一気に達成されるのではなく、小さなステップの積み重ねによって生み出される。", author: "フィンセント・ファン・ゴッホ / 19世紀オランダの画家『書簡集』" },
            { text: "最後の1分まで、全力を尽くした者にのみ勝利の美酒が与えられる。", author: "トゥキディデス / 古代ギリシャの歴史家『戦史』" },
            { text: "恐れるな。ただ信ぜよ。", author: "『新約聖書』マルコによる福音書・5章36節" },
            { text: "人生における真の栄光とは、決して倒れないことではなく、倒れるたびに起き上がることにある。", author: "オリヴァー・ゴールドスミス / 18世紀イギリスの作家" },
            { text: "苦難の時こそ、勇気と信念を示せ。", author: "ホラティウス / 古代ローマの詩人『頌歌』" },
            { text: "一念岩をも通す。", author: "司馬遷 / 前漢の歴史家『史記』李将軍列伝" },
            { text: "名誉は、最も困難な義務を果たした者に与えられる。", author: "プラトン / 古代ギリシャの哲学者『国家』" },
            { text: "我来たれり、我見たり、我勝てり。", author: "ガイウス・ユリウス・カエサル / 紀元前1世紀古代ローマの軍人・政治家" }
        ];
