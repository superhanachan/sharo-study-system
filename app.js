...
class QuizApp {
                    ...
                    fetch(`https://laws.e-gov.go.jp/api/1/lawdata/${lawId}`)
                        ...
                        .then(xmlText => {
                            ...
                            articles.forEach(art => {
                                ...
                                if (num && cap) {
                                    this.lawCaptionCache[lawId][num] = cap.textContent;
                                }
                            });
                            // Update existing DOM
                            ...
                            anchorDivs.forEach(div => {
                                ...
                                if (this.lawCaptionCache[lawId][articleNum]) {
                                    const capText = this.lawCaptionCache[lawId][articleNum];
    ...
    startArticleDrill(lawId, lawName, anchor) {
        ...
        const articleNum = anchor.replace('Mp-At_', '').replace('Sp-At_', '').split('-')[0];
        let captionText = "";
        if (this.lawCaptionCache && this.lawCaptionCache[lawId] && this.lawCaptionCache[lawId][articleNum]) {
            captionText = ` 【${this.lawCaptionCache[lawId][articleNum]}】`;
        }
