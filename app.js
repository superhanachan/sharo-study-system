...
class QuizApp {
    ...
    loadSet(id) {
        ...
        this.updateDashboard(); // Ensure mountain updates when loading
    }
    ...
    updateDashboard() {
        ...
        const now = new Date();
        const dueCount = allStats.filter(s => {
    ...
    generateDueReview(type, limit) {
        ...
        if (type === 'clause') {
            // For clauses, we take ONE randomly selected clause set and load it.
            // If the user wants 3, they can review them one by one or we'd need a multi-clause view.
